...
[![Stars](https://img.shields.io/github/stars/smnahidemon/Dex2C?color=yellow)](https://github.com/TeamUltroid/Ultroid/stargazers)
[![Python](https://img.shields.io/badge/Python-v3.10.3-blue)](https://www.python.org/)
[![Forks](https://img.shields.io/github/forks/smnahidemon/Dex2C?color=orange)](https://github.com/smnahidemon/Dex2C/fork)
[![Size](https://img.shields.io/github/repo-size/smnahidemon/Dex2C?color=green)](https://github.com/smnahidemon/Dex2C/)
[![Contributors](https://img.shields.io/github/contributors/smnahidemon/Dex2C?color=green)](https://github.com/smnahidemon/Dex2C/graphs/contributors)
...
1. Clone the repo.
   ```bash
   git clone https://github.com/smnahidemon/dex2c
   ```
...
One Step Installation: Run Below Command
   ```bash
   pkg install wget && wget -O termux_install.sh https://raw.githubusercontent.com/smnahidemon/dex2c/termux_install.sh && chmod -R +x termux_install.sh && ./termux_install.sh
   ```
...
```
Lcom/some/class;some_method(some_parameters)return_type
```
...
See the [open issues](https://github.com/smnahidemon/dex2c/issues) for a full list of proposed features and known issues.
