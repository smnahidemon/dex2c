...
Java_np_dex2c_Leeapk_initDcc__(JNIEnv *env, jobject thiz) {

}

JNIEXPORT void JNICALL
Java_np_dex2c_Leeapk__0003cinit_0003e__(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = env->FindClass("np/dex2c/Leeapk");
